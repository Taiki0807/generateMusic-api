...
from app.services.riffusion.datatypes import InferenceInput
from app.services.riffusion.external.prompt_weighting import get_weighted_text_embeddings
from app.services.riffusion.util import torch_util
...
class RiffusionPipeline(DiffusionPipeline):
    ...
    def riffuse(
        ...
        # Image latents
        init_image_torch = preprocess_image(init_image).to(device=self.device, dtype=embed_start.dtype)
